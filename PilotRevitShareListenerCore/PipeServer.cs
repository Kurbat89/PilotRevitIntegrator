...
using PilotRevitShareListenerCore.Server;
using System;
...
namespace PilotRevitShareListenerCore
{
    public class PipeServer
    {
        ...
        public void Start()
        {
            ...
            _pipe = new NamedPipeServerStream("rsl_admin", PipeDirection.InOut, 1, PipeTransmissionMode.Byte, PipeOptions.Asynchronous, 4096, 4096);
